...
function multiply(a,b){
  multiple = a * b;
  message1 = 'The product of ' + a + ' and ' + b + ' is ' + multiple + '.';
  return [multiple , message1];
}
...
function sumArray(testArray){
  ...
  console.log(sum1);
  var finalSum = sum(sum1, testArray[2])[0];
  return [finalSum, testArray + ' was passed in as an array of numbers, and ' + finalSum + ' is their sum.'];
...
function multiplyArray(testArray) {
  ...
  return [multiple2,'The numbers ' + testArray + ' have a product of ' + multiple2 + '.'];
